...
public class MatchSimulation {
    ...
    public static void simulateMatch(MatchDto match) {
        ...
        boolean messinaMatch = false;
        
        /*
        if (match.getHomeTeam().getName().equals("Messina") || match.getAwayTeam().getName().equals("Messina")) {
            if (match.getHomeTeam().getName().equals("Messina")) {
                match.getHomeTeam().getListOfPlayers().stream().forEach(player -> System.out.println(player.getPlayerName()));
                messinaMatch = true;
            } else if (match.getAwayTeam().getName().equals("Messina")) {
                match.getAwayTeam().getListOfPlayers().stream().forEach(player -> System.out.println(player.getPlayerName()));
                messinaMatch = true;
            }
            ...
            System.out.println("Write ok to start match");
            String input = sc.next();
            if (input.equals("ok")) {
                System.out.println("MESSINA meccs indul");
            }
...
//        int numberOfSmallHomeTeamChances = calculateNumberOfSmallChances(homeTeamForwardsAvg, homeTeamMidfieldersAvg, homeTeamDefendersAvg);
       ...
       // int numberOfSmallAwayTeamChances = calculateNumberOfSmallChances(awayTeamForwardsAvg, awayTeamMidfieldersAvg, awayTeamDefendersAvg);
        ...
        if (messinaMatch) {
            ...
            System.out.println("Write ok to continue with next match");
